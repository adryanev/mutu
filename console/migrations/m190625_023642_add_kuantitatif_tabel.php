...
class m190625_023642_add_kuantitatif_tabel extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->addForeignKey('fk-s7_data_kuantitatif_prodi-s7_akreditasi_prodi_s1','{{%s7_data_kuantitatif_prodi}}','id_akreditasi_prodi_s1','{{%s7_akreditasi_prodi_s1}}','id','CASCADE','CASCADE');
        $this->addForeignKey('fk-s7_data_kuantitatif_prodi-usr_crt', '{{%s7_data_kuantitatif_prodi}}','created_by','{{%user}}', 'id','CASCADE','CASCADE');
        $this->addForeignKey('fk-s7_data_kuantitatif_prodi-usr_upd', '{{%s7_data_kuantitatif_prodi}}','updated_by','{{%user}}', 'id','CASCADE','CASCADE');
        ...
        $this->addForeignKey('fk-s7_data_kuantitatif_institusi-s7_akreditasi','{{%s7_data_kuantitatif_institusi}}','id_akreditasi','{{%s7_akreditasi}}','id','CASCADE','CASCADE');
        $this->addForeignKey('fk-s7_data_kuantitatif_institusi-usr_crt', '{{%s7_data_kuantitatif_institusi}}','created_by','{{%user}}', 'id','CASCADE','CASCADE');
        $this->addForeignKey('fk-s7_data_kuantitatif_institusi-usr_upd', '{{%s7_data_kuantitatif_institusi}}','updated_by','{{%user}}', 'id','CASCADE','CASCADE');
    }
