...
class m190506_045438_add_relational extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->addForeignKey('fk-akreditasi_prodi_s2-akreditasi','{{%s7_akreditasi_prodi_s2}}','id_akreditasi','{{%s7_akreditasi}}','id');
        $this->addForeignKey('fk-akreditasi_prodi_s2-program_studi','{{%s7_akreditasi_prodi_s2}}','id_prodi','{{%program_studi}}','id');
        $this->addForeignKey('fk-akreditasi_prodi_s3-akreditasi','{{%s7_akreditasi_prodi_s3}}','id_akreditasi','{{%s7_akreditasi}}','id');
        $this->addForeignKey('fk-akreditasi_prodi_s3-program_studi','{{%s7_akreditasi_prodi_s3}}','id_prodi','{{%program_studi}}','id');
        ...
        $this->addForeignKey('fk-borang_diploma_akademi-akreditasi_prodi_diploma','{{%s7_borang_diploma_akademi}}','id_akreditasi_prodi_diploma','{{%s7_akreditasi_prodi_diploma}}','id');
        ...
        $this->addForeignKey('fk-borang_s3_prodi-akreditasi_prodi_s2','{{%s7_borang_s3_prodi}}','id_akreditasi_prodi_s3','{{%s7_akreditasi_prodi_s3}}','id');
        $this->addForeignKey('fk-borang_s3_fakultas-akreditasi_prodi_s2','{{%s7_borang_s3_fakultas}}','id_akreditasi_prodi_s3','{{%s7_akreditasi_prodi_s3}}','id');
    ...
    public function safeDown()
    {
        ...
        //tabel2
        $this->dropForeignKey('fk-borang_s2_fakultas-akreditasi_prodi_s3','{{%s7_borang_s2_fakultas}}');
        $this->dropForeignKey('fk-borang_s2_prodi-akreditasi_prodi_s3','{{%s7_borang_s2_prodi}}');
        $this->dropForeignKey('fk-borang_s2_fakultas-akreditasi_prodi_s2','{{%s7_borang_s2_fakultas}}');
        ...
        $this->dropForeignKey('fk-akreditasi_prodi_s3-program_studi','{{%s7_akreditasi_prodi_s3}}');
        $this->dropForeignKey('fk-akreditasi_prodi_s3-akreditasi','{{%s7_akreditasi_prodi_s3}}');
        $this->dropForeignKey('fk-akreditasi_prodi_s2-program_studi','{{%s7_akreditasi_prodi_s2}}');
        $this->dropForeignKey('fk-akreditasi_prodi_s2-akreditasi','{{%s7_akreditasi_prodi_s2}}');
