...
class m190620_044719_add_dokumentasi_pasca_tabel extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->addForeignKey('fk-dok_pasca_prodi-akreditasi_prodi_pasca','{{%s7_dokumentasi_pasca_prodi}}','id_akreditasi_prodi_pasca', '{{%s7_akreditasi_prodi_pasca}}','id','CASCADE','CASCADE');

        // foreign key tabel dokumen s1 prodi standar
        $this->addForeignKey('fk-dok_pasca_prodi_standar1-dok_pasca_prodi', '{{%s7_dokumentasi_pasca_prodi_standar1}}', 'id_dokumentasi_pasca_prodi', '{{%s7_dokumentasi_pasca_prodi}}', 'id','CASCADE','CASCADE');

        $this->addForeignKey('fk-dok_pasca_prodi_standar2-dok_pasca_prodi', '{{%s7_dokumentasi_pasca_prodi_standar2}}', 'id_dokumentasi_pasca_prodi', '{{%s7_dokumentasi_pasca_prodi}}', 'id','CASCADE','CASCADE');

        $this->addForeignKey('fk-dok_pasca_prodi_standar3-dok_pasca_prodi', '{{%s7_dokumentasi_pasca_prodi_standar3}}', 'id_dokumentasi_pasca_prodi', '{{%s7_dokumentasi_pasca_prodi}}', 'id','CASCADE','CASCADE');

        $this->addForeignKey('fk-dok_pasca_prodi_standar4-dok_pasca_prodi', '{{%s7_dokumentasi_pasca_prodi_standar4}}', 'id_dokumentasi_pasca_prodi', '{{%s7_dokumentasi_pasca_prodi}}', 'id','CASCADE','CASCADE');

        $this->addForeignKey('fk-dok_pasca_prodi_standar5-dok_pasca_prodi', '{{%s7_dokumentasi_pasca_prodi_standar5}}', 'id_dokumentasi_pasca_prodi', '{{%s7_dokumentasi_pasca_prodi}}', 'id','CASCADE','CASCADE');

        $this->addForeignKey('fk-dok_pasca_prodi_standar6-dok_pasca_prodi', '{{%s7_dokumentasi_pasca_prodi_standar6}}', 'id_dokumentasi_pasca_prodi', '{{%s7_dokumentasi_pasca_prodi}}', 'id','CASCADE','CASCADE');

        $this->addForeignKey('fk-dok_pasca_prodi_standar7-dok_pasca_prodi', '{{%s7_dokumentasi_pasca_prodi_standar7}}', 'id_dokumentasi_pasca_prodi', '{{%s7_dokumentasi_pasca_prodi}}', 'id','CASCADE','CASCADE');

        // foreign key tabel user created updated s1 prodi standar
        $this->addForeignKey('fk-dok_pasca_prodi_standar1-usr_crt', '{{%s7_dokumentasi_pasca_prodi_standar1}}', 'created_by', '{{%user}}', 'id','CASCADE','CASCADE');
        $this->addForeignKey('fk-dok_pasca_prodi_standar1-usr_upd', '{{%s7_dokumentasi_pasca_prodi_standar1}}', 'updated_by', '{{%user}}', 'id','CASCADE','CASCADE');

        $this->addForeignKey('fk-dok_pasca_prodi_standar2-usr_crt', '{{%s7_dokumentasi_pasca_prodi_standar2}}', 'created_by', '{{%user}}', 'id','CASCADE','CASCADE');
        $this->addForeignKey('fk-dok_pasca_prodi_standar2-usr_upd', '{{%s7_dokumentasi_pasca_prodi_standar2}}', 'updated_by', '{{%user}}', 'id','CASCADE','CASCADE');

        $this->addForeignKey('fk-dok_pasca_prodi_standar3-usr_crt', '{{%s7_dokumentasi_pasca_prodi_standar3}}', 'created_by', '{{%user}}', 'id','CASCADE','CASCADE');
        $this->addForeignKey('fk-dok_pasca_prodi_standar3-usr_upd', '{{%s7_dokumentasi_pasca_prodi_standar3}}', 'updated_by', '{{%user}}', 'id','CASCADE','CASCADE');

        $this->addForeignKey('fk-dok_pasca_prodi_standar4-usr_crt', '{{%s7_dokumentasi_pasca_prodi_standar4}}', 'created_by', '{{%user}}', 'id','CASCADE','CASCADE');
        $this->addForeignKey('fk-dok_pasca_prodi_standar4-usr_upd', '{{%s7_dokumentasi_pasca_prodi_standar4}}', 'updated_by', '{{%user}}', 'id','CASCADE','CASCADE');

        $this->addForeignKey('fk-dok_pasca_prodi_standar5-usr_crt', '{{%s7_dokumentasi_pasca_prodi_standar5}}', 'created_by', '{{%user}}', 'id','CASCADE','CASCADE');
        $this->addForeignKey('fk-dok_pasca_prodi_standar5-usr_upd', '{{%s7_dokumentasi_pasca_prodi_standar5}}', 'updated_by', '{{%user}}', 'id','CASCADE','CASCADE');

        $this->addForeignKey('fk-dok_pasca_prodi_standar6-usr_crt', '{{%s7_dokumentasi_pasca_prodi_standar6}}', 'created_by', '{{%user}}', 'id','CASCADE','CASCADE');
        $this->addForeignKey('fk-dok_pasca_prodi_standar6-usr_upd', '{{%s7_dokumentasi_pasca_prodi_standar6}}', 'updated_by', '{{%user}}', 'id','CASCADE','CASCADE');

        $this->addForeignKey('fk-dok_pasca_prodi_standar7-usr_crt', '{{%s7_dokumentasi_pasca_prodi_standar7}}', 'created_by', '{{%user}}', 'id','CASCADE','CASCADE');
        $this->addForeignKey('fk-dok_pasca_prodi_standar7-usr_upd', '{{%s7_dokumentasi_pasca_prodi_standar7}}', 'updated_by', '{{%user}}', 'id','CASCADE','CASCADE');
...
// create tabel dokumentasi pasca fakultas dan standar
        ...
        // foreign key tabel dokumentasi s1 prodi
        $this->addForeignKey('fk-dok_pasca_fakultas-akreditasi_prodi_pasca','{{%s7_dokumentasi_pasca_fakultas}}','id_akreditasi', '{{%s7_akreditasi}}','id','CASCADE','CASCADE');
        $this->addForeignKey('fk-dok_pasca_fakultas-fakultas_akademi','{{%s7_dokumentasi_pasca_fakultas}}','id_fakultas', '{{%fakultas_akademi}}','id','CASCADE','CASCADE');

        // foreign key tabel dokumen s1 prodi standar
        $this->addForeignKey('fk-dok_pasca_standar1_fakultas-dok_pasca_fakultas', '{{%s7_dokumentasi_pasca_fakultas_standar1}}', 'id_dokumentasi_pasca_fakultas', '{{%s7_dokumentasi_pasca_fakultas}}', 'id','CASCADE','CASCADE');

        $this->addForeignKey('fk-dok_pasca_standar2_fakultas-dok_pasca_fakultas', '{{%s7_dokumentasi_pasca_fakultas_standar2}}', 'id_dokumentasi_pasca_fakultas', '{{%s7_dokumentasi_pasca_fakultas}}', 'id','CASCADE','CASCADE');

        $this->addForeignKey('fk-dok_pasca_standar3_fakultas-dok_pasca_fakultas', '{{%s7_dokumentasi_pasca_fakultas_standar3}}', 'id_dokumentasi_pasca_fakultas', '{{%s7_dokumentasi_pasca_fakultas}}', 'id','CASCADE','CASCADE');

        $this->addForeignKey('fk-dok_pasca_standar4_fakultas-dok_pasca_fakultas', '{{%s7_dokumentasi_pasca_fakultas_standar4}}', 'id_dokumentasi_pasca_fakultas', '{{%s7_dokumentasi_pasca_fakultas}}', 'id','CASCADE','CASCADE');

        $this->addForeignKey('fk-dok_pasca_standar5_fakultas-dok_pasca_fakultas', '{{%s7_dokumentasi_pasca_fakultas_standar5}}', 'id_dokumentasi_pasca_fakultas', '{{%s7_dokumentasi_pasca_fakultas}}', 'id','CASCADE','CASCADE');

        $this->addForeignKey('fk-dok_pasca_standar6_fakultas-dok_pasca_fakultas', '{{%s7_dokumentasi_pasca_fakultas_standar6}}', 'id_dokumentasi_pasca_fakultas', '{{%s7_dokumentasi_pasca_fakultas}}', 'id','CASCADE','CASCADE');

        $this->addForeignKey('fk-dok_pasca_standar7_fakultas-dok_pasca_fakultas', '{{%s7_dokumentasi_pasca_fakultas_standar7}}', 'id_dokumentasi_pasca_fakultas', '{{%s7_dokumentasi_pasca_fakultas}}', 'id','CASCADE','CASCADE');

        // foreign key tabel user created updated s1 prodi standar
        $this->addForeignKey('fk-dok_pasca_standar1_fakultas-usr_crt', '{{%s7_dokumentasi_pasca_fakultas_standar1}}', 'created_by', '{{%user}}', 'id','CASCADE','CASCADE');
        $this->addForeignKey('fk-dok_pasca_standar1_fakultas-usr_upd', '{{%s7_dokumentasi_pasca_fakultas_standar1}}', 'updated_by', '{{%user}}', 'id','CASCADE','CASCADE');

        $this->addForeignKey('fk-dok_pasca_standar2_fakultas-usr_crt', '{{%s7_dokumentasi_pasca_fakultas_standar2}}', 'created_by', '{{%user}}', 'id','CASCADE','CASCADE');
        $this->addForeignKey('fk-dok_pasca_standar2_fakultas-usr_upd', '{{%s7_dokumentasi_pasca_fakultas_standar2}}', 'updated_by', '{{%user}}', 'id','CASCADE','CASCADE');

        $this->addForeignKey('fk-dok_pasca_standar3_fakultas-usr_crt', '{{%s7_dokumentasi_pasca_fakultas_standar3}}', 'created_by', '{{%user}}', 'id','CASCADE','CASCADE');
        $this->addForeignKey('fk-dok_pasca_standar3_fakultas-usr_upd', '{{%s7_dokumentasi_pasca_fakultas_standar3}}', 'updated_by', '{{%user}}', 'id','CASCADE','CASCADE');

        $this->addForeignKey('fk-dok_pasca_standar4_fakultas-usr_crt', '{{%s7_dokumentasi_pasca_fakultas_standar4}}', 'created_by', '{{%user}}', 'id','CASCADE','CASCADE');
        $this->addForeignKey('fk-dok_pasca_standar4_fakultas-usr_upd', '{{%s7_dokumentasi_pasca_fakultas_standar4}}', 'updated_by', '{{%user}}', 'id','CASCADE','CASCADE');

        $this->addForeignKey('fk-dok_pasca_standar5_fakultas-usr_crt', '{{%s7_dokumentasi_pasca_fakultas_standar5}}', 'created_by', '{{%user}}', 'id','CASCADE','CASCADE');
        $this->addForeignKey('fk-dok_pasca_standar5_fakultas-usr_upd', '{{%s7_dokumentasi_pasca_fakultas_standar5}}', 'updated_by', '{{%user}}', 'id','CASCADE','CASCADE');

        $this->addForeignKey('fk-dok_pasca_standar6_fakultas-usr_crt', '{{%s7_dokumentasi_pasca_fakultas_standar6}}', 'created_by', '{{%user}}', 'id','CASCADE','CASCADE');
        $this->addForeignKey('fk-dok_pasca_standar6_fakultas-usr_upd', '{{%s7_dokumentasi_pasca_fakultas_standar6}}', 'updated_by', '{{%user}}', 'id','CASCADE','CASCADE');

        $this->addForeignKey('fk-dok_pasca_standar7_fakultas-usr_crt', '{{%s7_dokumentasi_pasca_fakultas_standar7}}', 'created_by', '{{%user}}', 'id','CASCADE','CASCADE');
        $this->addForeignKey('fk-dok_pasca_standar7_fakultas-usr_upd', '{{%s7_dokumentasi_pasca_fakultas_standar7}}', 'updated_by', '{{%user}}', 'id','CASCADE','CASCADE');
