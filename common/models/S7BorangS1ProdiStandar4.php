 ...
 * @property S7DetailBorangS1ProdiStandar4[] $detailBorangS1ProdiStandar4s
 */
class S7BorangS1ProdiStandar4 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 's7_borang_s1_prodi_standar4';
    }
    ...
    {
        return $this->hasMany(S7DetailBorangS1ProdiStandar4::className(), ['id_borang_s1_prodi_standar4' => 'id']);
    }
}
