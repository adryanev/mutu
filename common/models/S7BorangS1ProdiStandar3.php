 ...
 * @property S7DetailBorangS1ProdiStandar3[] $detailBorangS1ProdiStandar3s
 */
class S7BorangS1ProdiStandar3 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 's7_borang_s1_prodi_standar3';
    }
    ...
    {
        return $this->hasMany(S7DetailBorangS1ProdiStandar3::className(), ['id_borang_s1_prodi_standar3' => 'id']);
    }
}
