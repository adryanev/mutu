 ...
 * @property S7DetailBorangInstitusiStandar5[] $detailBorangInstitusiStandar5s
 */
class S7BorangInstitusiStandar5 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 's7_borang_institusi_standar5';
    }
    ...
    {
        return $this->hasMany(S7DetailBorangInstitusiStandar5::className(), ['id_borang_institusi_standar5' => 'id']);
    }
}
