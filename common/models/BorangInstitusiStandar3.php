 ...
 * @property DetailBorangInstitusiStandar3[] $detailBorangInstitusiStandar3s
 */
class BorangInstitusiStandar3 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'borang_institusi_standar3';
    }
    ...
    {
        return $this->hasMany(DetailBorangInstitusiStandar3::className(), ['id_borang_institusi_standar3' => 'id']);
    }
}
