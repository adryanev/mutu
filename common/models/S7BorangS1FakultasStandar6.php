 ...
 * @property S7DetailBorangS1FakultasStandar6[] $detailBorangS1FakultasStandar6s
 */
class S7BorangS1FakultasStandar6 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasMany(S7DetailBorangS1FakultasStandar6::className(), ['id_borang_s1_fakultas_standar6' => 'id']);
    }
}
