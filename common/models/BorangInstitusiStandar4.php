 ...
 * @property DetailBorangInstitusiStandar4[] $detailBorangInstitusiStandar4s
 */
class BorangInstitusiStandar4 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasMany(DetailBorangInstitusiStandar4::className(), ['id_borang_institusi_standar4' => 'id']);
    }
}
