 ...
 * @property S7DetailBorangInstitusiStandar7[] $detailBorangInstitusiStandar7s
 */
class S7BorangInstitusiStandar7 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 's7_borang_institusi_standar7';
    }
    ...
    {
        return $this->hasMany(S7DetailBorangInstitusiStandar7::className(), ['id_borang_institusi_standar7' => 'id']);
    }
}
