...
/**
 * This is the model class for table "s7_borang_pasca_prodi_standar6".
 *
 * @property int $id
 ...
 * @property S7DetailBorangPascaProdiStandar6[] $s7DetailBorangPascaProdiStandar6s
 */
class S7BorangPascaProdiStandar6 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 's7_borang_pasca_prodi_standar6';
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getS7DetailBorangPascaProdiStandar6s()
    {
        return $this->hasMany(S7DetailBorangPascaProdiStandar6::className(), ['id_borang_pasca_prodi_standar6' => 'id']);
    }
}
