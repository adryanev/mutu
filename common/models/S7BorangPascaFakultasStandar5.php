...
/**
 * This is the model class for table "s7_borang_pasca_fakultas_standar5".
 *
 * @property int $id
 ...
 * @property S7DetailBorangPascaFakultasStandar5[] $s7DetailBorangPascaFakultasStandar5s
 */
class S7BorangPascaFakultasStandar5 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 's7_borang_pasca_fakultas_standar5';
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getS7DetailBorangPascaFakultasStandar5s()
    {
        return $this->hasMany(S7DetailBorangPascaFakultasStandar5::className(), ['id_borang_pasca_fakultas_standar5' => 'id']);
    }
}
