 ...
 * @property S7DetailBorangS1FakultasStandar7[] $detailBorangS1FakultasStandar7s
 */
class S7BorangS1FakultasStandar7 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 's7_borang_s1_fakultas_standar7';
    }
    ...
    {
        return $this->hasMany(S7DetailBorangS1FakultasStandar7::className(), ['id_borang_s1_fakultas_standar7' => 'id']);
    }
}
