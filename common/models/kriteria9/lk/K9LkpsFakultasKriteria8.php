...
/**
 * This is the model class for table "k9_lkps_fakultas_kriteria8".
 *
 * @property int $id
 ...
 * @property K9LkpsFakultasKriteria8Detail[] $k9LkpsFakultasKriteria8Details
 */
class K9LkpsFakultasKriteria8 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'k9_lkps_fakultas_kriteria8';
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getK9LkpsFakultasKriteria8Details()
    {
        return $this->hasMany(K9LkpsFakultasKriteria8Detail::className(), ['id_lkps_fakultas_kriteria8' => 'id']);
    }
}
