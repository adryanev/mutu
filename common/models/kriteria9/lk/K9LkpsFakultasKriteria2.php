...
/**
 * This is the model class for table "k9_lkps_fakultas_kriteria2".
 *
 * @property int $id
 ...
 * @property K9LkpsFakultasKriteria2Detail[] $k9LkpsFakultasKriteria2Details
 */
class K9LkpsFakultasKriteria2 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'k9_lkps_fakultas_kriteria2';
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getK9LkpsFakultasKriteria2Details()
    {
        return $this->hasMany(K9LkpsFakultasKriteria2Detail::className(), ['id_lkps_fakultas_kriteria2' => 'id']);
    }
}
