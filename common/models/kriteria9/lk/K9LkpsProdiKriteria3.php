...
/**
 * This is the model class for table "k9_lkps_prodi_kriteria3".
 *
 * @property int $id
 ...
 * @property K9LkpsProdiKriteria3Detail[] $k9LkpsProdiKriteria3Details
 */
class K9LkpsProdiKriteria3 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'k9_lkps_prodi_kriteria3';
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getK9LkpsProdiKriteria3Details()
    {
        return $this->hasMany(K9LkpsProdiKriteria3Detail::className(), ['id_lkps_prodi_kriteria3' => 'id']);
    }
}
