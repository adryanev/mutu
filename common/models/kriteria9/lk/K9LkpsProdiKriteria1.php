...
/**
 * This is the model class for table "k9_lkps_prodi_kriteria1".
 *
 * @property int $id
 ...
 * @property K9LkpsProdiKriteria1Detail[] $k9LkpsProdiKriteria1Details
 */
class K9LkpsProdiKriteria1 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'k9_lkps_prodi_kriteria1';
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getK9LkpsProdiKriteria1Details()
    {
        return $this->hasMany(K9LkpsProdiKriteria1Detail::className(), ['id_lkps_prodi_kriteria1' => 'id']);
    }
}
