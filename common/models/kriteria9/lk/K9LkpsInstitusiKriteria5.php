...
/**
 * This is the model class for table "k9_lkps_institusi_kriteria5".
 *
 * @property int $id
 ...
 * @property K9LkpsInstitusiKriteria5Detail[] $k9LkpsInstitusiKriteria5Details
 */
class K9LkpsInstitusiKriteria5 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'k9_lkps_institusi_kriteria5';
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getK9LkpsInstitusiKriteria5Details()
    {
        return $this->hasMany(K9LkpsInstitusiKriteria5Detail::className(), ['id_lkps_institusi_kriteria5' => 'id']);
    }
}
