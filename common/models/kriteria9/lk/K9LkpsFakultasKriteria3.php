...
/**
 * This is the model class for table "k9_lkps_fakultas_kriteria3".
 *
 * @property int $id
 ...
 * @property K9LkpsFakultasKriteria3Detail[] $k9LkpsFakultasKriteria3Details
 */
class K9LkpsFakultasKriteria3 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'k9_lkps_fakultas_kriteria3';
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getK9LkpsFakultasKriteria3Details()
    {
        return $this->hasMany(K9LkpsFakultasKriteria3Detail::className(), ['id_lkps_fakultas_kriteria3' => 'id']);
    }
}
