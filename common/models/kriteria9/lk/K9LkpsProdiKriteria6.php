...
/**
 * This is the model class for table "k9_lkps_prodi_kriteria6".
 *
 * @property int $id
 ...
 * @property K9LkpsProdiKriteria6Detail[] $k9LkpsProdiKriteria6Details
 */
class K9LkpsProdiKriteria6 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'k9_lkps_prodi_kriteria6';
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getK9LkpsProdiKriteria6Details()
    {
        return $this->hasMany(K9LkpsProdiKriteria6Detail::className(), ['id_lkps_prodi_kriteria6' => 'id']);
    }
}
