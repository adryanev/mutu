...
/**
 * This is the model class for table "k9_lkps_institusi_kriteria3".
 *
 * @property int $id
 ...
 * @property K9LkpsInstitusiKriteria3Detail[] $k9LkpsInstitusiKriteria3Details
 */
class K9LkpsInstitusiKriteria3 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'k9_lkps_institusi_kriteria3';
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getK9LkpsInstitusiKriteria3Details()
    {
        return $this->hasMany(K9LkpsInstitusiKriteria3Detail::className(), ['id_lkps_institusi_kriteria3' => 'id']);
    }
}
