...
/**
 * This is the model class for table "k9_lkps_institusi_kriteria7".
 *
 * @property int $id
 ...
 * @property K9LkpsInstitusiKriteria7Detail[] $k9LkpsInstitusiKriteria7Details
 */
class K9LkpsInstitusiKriteria7 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'k9_lkps_institusi_kriteria7';
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getK9LkpsInstitusiKriteria7Details()
    {
        return $this->hasMany(K9LkpsInstitusiKriteria7Detail::className(), ['id_lkps_institusi_kriteria7' => 'id']);
    }
}
