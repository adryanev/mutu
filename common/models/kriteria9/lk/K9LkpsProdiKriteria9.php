...
/**
 * This is the model class for table "k9_lkps_prodi_kriteria9".
 *
 * @property int $id
 ...
 * @property K9LkpsProdiKriteria9Detail[] $k9LkpsProdiKriteria9Details
 */
class K9LkpsProdiKriteria9 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'k9_lkps_prodi_kriteria9';
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getK9LkpsProdiKriteria9Details()
    {
        return $this->hasMany(K9LkpsProdiKriteria9Detail::className(), ['id_lkps_prodi_kriteria9' => 'id']);
    }
}
