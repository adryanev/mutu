...
/**
 * This is the model class for table "k9_lkps_fakultas_kriteria7".
 *
 * @property int $id
 ...
 * @property K9LkpsFakultasKriteria7Detail[] $k9LkpsFakultasKriteria7Details
 */
class K9LkpsFakultasKriteria7 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'k9_lkps_fakultas_kriteria7';
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getK9LkpsFakultasKriteria7Details()
    {
        return $this->hasMany(K9LkpsFakultasKriteria7Detail::className(), ['id_lkps_fakultas_kriteria7' => 'id']);
    }
}
