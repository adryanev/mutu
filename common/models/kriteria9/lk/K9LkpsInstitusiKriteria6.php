...
/**
 * This is the model class for table "k9_lkps_institusi_kriteria6".
 *
 * @property int $id
 ...
 * @property K9LkpsInstitusiKriteria6Detail[] $k9LkpsInstitusiKriteria6Details
 */
class K9LkpsInstitusiKriteria6 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'k9_lkps_institusi_kriteria6';
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getK9LkpsInstitusiKriteria6Details()
    {
        return $this->hasMany(K9LkpsInstitusiKriteria6Detail::className(), ['id_lkps_institusi_kriteria6' => 'id']);
    }
}
