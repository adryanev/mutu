...
/**
 * This is the model class for table "k9_lkps_prodi_kriteria8".
 *
 * @property int $id
 ...
 * @property K9LkpsProdiKriteria8Detail[] $k9LkpsProdiKriteria8Details
 */
class K9LkpsProdiKriteria8 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'k9_lkps_prodi_kriteria8';
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getK9LkpsProdiKriteria8Details()
    {
        return $this->hasMany(K9LkpsProdiKriteria8Detail::className(), ['id_lkps_prodi_kriteria8' => 'id']);
    }
}
