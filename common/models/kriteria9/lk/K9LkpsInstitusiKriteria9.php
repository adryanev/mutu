...
/**
 * This is the model class for table "k9_lkps_institusi_kriteria9".
 *
 * @property int $id
 ...
 * @property K9LkpsInstitusiKriteria9Detail[] $k9LkpsInstitusiKriteria9Details
 */
class K9LkpsInstitusiKriteria9 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'k9_lkps_institusi_kriteria9';
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getK9LkpsInstitusiKriteria9Details()
    {
        return $this->hasMany(K9LkpsInstitusiKriteria9Detail::className(), ['id_lkps_institusi_kriteria9' => 'id']);
    }
}
