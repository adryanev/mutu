...
/**
 * This is the model class for table "k9_lkps_prodi_kriteria4".
 *
 * @property int $id
 ...
 * @property K9LkpsProdiKriteria4Detail[] $k9LkpsProdiKriteria4Details
 */
class K9LkpsProdiKriteria4 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'k9_lkps_prodi_kriteria4';
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getK9LkpsProdiKriteria4Details()
    {
        return $this->hasMany(K9LkpsProdiKriteria4Detail::className(), ['id_lkps_prodi_kriteria4' => 'id']);
    }
}
