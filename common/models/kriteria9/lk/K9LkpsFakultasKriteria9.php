...
/**
 * This is the model class for table "k9_lkps_fakultas_kriteria9".
 *
 * @property int $id
 ...
 * @property K9LkpsFakultasKriteria9Detail[] $k9LkpsFakultasKriteria9Details
 */
class K9LkpsFakultasKriteria9 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'k9_lkps_fakultas_kriteria9';
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getK9LkpsFakultasKriteria9Details()
    {
        return $this->hasMany(K9LkpsFakultasKriteria9Detail::className(), ['id_lkps_fakultas_kriteria9' => 'id']);
    }
}
