...
/**
 * This is the model class for table "k9_lkps_prodi_kriteria5".
 *
 * @property int $id
 ...
 * @property K9LkpsProdiKriteria5Detail[] $k9LkpsProdiKriteria5Details
 */
class K9LkpsProdiKriteria5 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'k9_lkps_prodi_kriteria5';
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getK9LkpsProdiKriteria5Details()
    {
        return $this->hasMany(K9LkpsProdiKriteria5Detail::className(), ['id_lkps_prodi_kriteria5' => 'id']);
    }
}
