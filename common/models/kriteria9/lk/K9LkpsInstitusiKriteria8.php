...
/**
 * This is the model class for table "k9_lkps_institusi_kriteria8".
 *
 * @property int $id
 ...
 * @property K9LkpsInstitusiKriteria8Detail[] $k9LkpsInstitusiKriteria8Details
 */
class K9LkpsInstitusiKriteria8 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'k9_lkps_institusi_kriteria8';
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getK9LkpsInstitusiKriteria8Details()
    {
        return $this->hasMany(K9LkpsInstitusiKriteria8Detail::className(), ['id_lkps_institusi_kriteria8' => 'id']);
    }
}
