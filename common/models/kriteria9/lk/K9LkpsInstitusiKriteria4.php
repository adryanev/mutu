...
/**
 * This is the model class for table "k9_lkps_institusi_kriteria4".
 *
 * @property int $id
 ...
 * @property K9LkpsInstitusiKriteria4Detail[] $k9LkpsInstitusiKriteria4Details
 */
class K9LkpsInstitusiKriteria4 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'k9_lkps_institusi_kriteria4';
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getK9LkpsInstitusiKriteria4Details()
    {
        return $this->hasMany(K9LkpsInstitusiKriteria4Detail::className(), ['id_lkps_institusi_kriteria4' => 'id']);
    }
}
