 ...
 * @property DetailBorangInstitusiStandar2[] $detailBorangInstitusiStandar2s
 */
class BorangInstitusiStandar2 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'borang_institusi_standar2';
    }
    ...
    {
        return $this->hasMany(DetailBorangInstitusiStandar2::className(), ['id_borang_institusi_standar2' => 'id']);
    }
}
