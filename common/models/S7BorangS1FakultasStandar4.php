 ...
 * @property S7DetailBorangS1FakultasStandar4[] $detailBorangS1FakultasStandar4s
 */
class S7BorangS1FakultasStandar4 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 's7_borang_s1_fakultas_standar4';
    }
    ...
    {
        return $this->hasMany(S7DetailBorangS1FakultasStandar4::className(), ['id_borang_s1_fakultas_standar4' => 'id']);
    }
}
