 ...
 * @property S7BorangS1ProdiStandar2 $borangS1ProdiStandar2
 */
class S7DetailBorangS1ProdiStandar2 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['id_borang_s1_prodi_standar2'], 'exist', 'skipOnError' => true, 'targetClass' => S7BorangS1ProdiStandar2::className(), 'targetAttribute' => ['id_borang_s1_prodi_standar2' => 'id']],
        ];
    }
    ...
    {
        return $this->hasOne(S7BorangS1ProdiStandar2::className(), ['id' => 'id_borang_s1_prodi_standar2']);
    }
}
