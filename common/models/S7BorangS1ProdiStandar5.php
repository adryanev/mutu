 ...
 * @property S7DetailBorangS1ProdiStandar5[] $detailBorangS1ProdiStandar5s
 */
class S7BorangS1ProdiStandar5 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 's7_borang_s1_prodi_standar5';
    }
    ...
    {
        return $this->hasMany(S7DetailBorangS1ProdiStandar5::className(), ['id_borang_s1_prodi_standar5' => 'id']);
    }
}
