...
/**
 * This is the model class for table "s7_gambar_borang_pasca_fakultas".
 *
 * @property int $id
 ...
 */
class S7GambarBorangPascaFakultas extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 's7_gambar_borang_pasca_fakultas';
    }
