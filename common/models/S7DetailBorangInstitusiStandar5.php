 ...
 * @property S7BorangInstitusiStandar5 $borangInstitusiStandar5
 */
class S7DetailBorangInstitusiStandar5 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['id_borang_institusi_standar5'], 'exist', 'skipOnError' => true, 'targetClass' => S7BorangInstitusiStandar5::className(), 'targetAttribute' => ['id_borang_institusi_standar5' => 'id']],
        ];
    }
    ...
    {
        return $this->hasOne(S7BorangInstitusiStandar5::className(), ['id' => 'id_borang_institusi_standar5']);
    }
}
