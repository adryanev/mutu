 ...
 * @property S7DetailBorangInstitusiStandar6[] $detailBorangInstitusiStandar6s
 */
class S7BorangInstitusiStandar6 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 's7_borang_institusi_standar6';
    }
    ...
    {
        return $this->hasMany(S7DetailBorangInstitusiStandar6::className(), ['id_borang_institusi_standar6' => 'id']);
    }
}
