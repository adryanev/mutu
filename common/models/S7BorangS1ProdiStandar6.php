 ...
 * @property S7DetailBorangS1ProdiStandar6[] $detailBorangS1ProdiStandar6s
 */
class S7BorangS1ProdiStandar6 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 's7_borang_s1_prodi_standar6';
    }
    ...
    {
        return $this->hasMany(S7DetailBorangS1ProdiStandar6::className(), ['id_borang_s1_prodi_standar6' => 'id']);
    }
}
