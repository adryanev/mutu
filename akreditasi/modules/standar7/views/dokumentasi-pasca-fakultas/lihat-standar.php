...
$this->params['breadcrumbs'][] = ['label'=>'Lihat Dokumentasi','url'=>['dokumentasi-pasca-fakultas/lihat','dokumentasi'=>$dokProdi->id]];
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="pull-right">
                                                    ...
                                                    ?>
                                                    &nbsp;
                                                    <?php if($asesor === 0) { echo '<button class="btn btn-warning btn-simple">Tidak Asesor</button>'; }
                                                    else { echo '<button class="btn btn-success btn-simple">Asesor</button>';}
                                                    ?>
                                                </div>
