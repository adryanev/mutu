...
/* @var $this View */
/* @var $model S7BorangPascaFakultasStandar1Form */
/* @var $detailModel S7DetailBorangPascaFakultasStandar1 */
/* @var $modelIsian IsianBorangPascaFakultasUploadForm */
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <table class="table table-striped table-hover">
                                                        ...
                                                        $data = \common\models\S7IsianBorangPascaFakultas::find()->where(['id_borang_pasca_prodi' => $_GET['borang'], 'id_isian_borang' => $nomor])->all();
