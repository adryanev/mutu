...
$this->params['breadcrumbs'][] = ['label'=>'Isi Borang','url'=>['borang-pasca-prodi/isi','borang'=>$model->id_borang_pasca]];
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <table class="table table-striped table-hover">
                                                                ...
                                                                <tbody>
                                                                        ...
                                                                        <?php
                                                                        $nomor = S7IsianBorang::findOne(['nomor_borang'=>$value['nomor'],'untuk'=>'prodi']);
                                                                        $data = S7IsianBorangPascaProdi::find()->where(['id_borang_s1_prodi'=>$_GET['borang'],'id_isian_borang'=>$nomor->id])->all();
                                                                            ...
                                                                            <td>
                                                                                <div class="row">
                                                                                    <div class="col-md-12">
                                                                                        ...
                                                                                        <?=Html::a('Hapus',['borang-pasca-prodi/hapus-isian'],[
                                                            ...
                                                            <td>
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <?=Html::a('Hapus',['borang-pasca-prodi/hapus-detail'],[
                                                                                'class'=>'btn btn-danger',
                                                                                'data'=>[
                                                                                        'method'=>'POST',
                                                                                        'confirm'=>'Apakah anda yakin menghapus item ini?',
