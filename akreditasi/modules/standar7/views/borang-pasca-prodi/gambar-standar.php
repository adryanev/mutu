...
/* @var $this View */
/* @var $model S7GambarBorangPascaProdi */
/* @var $dataBorang S7BorangPascaProdi */
/* @var $gambarForm GambarBorangPascaProdiUploadForm */
/** @var array $poin */
$standar = $json['standar'];

$this->title = 'Standar ' . $standar;
$this->params['breadcrumbs'][] = ['label' => 'Unggah Gambar', 'url' => ['borang-pasca-prodi/unggah', 'borang' => $_GET['borang']]];
                                    ...
                                    <td class="gambar">
                                        <div class="row">
                                            <div class="col-md-12"
                                                >
                                                <?php
                                                $dataGambar = S7GambarBorangPascaProdi::findAll(['id_borang_pasca_prodi' => $_GET['borang'], 'nomor_borang' => $value['nomor']]);
                                                foreach ($dataGambar as $gambar):?>
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <div class="col-md-12">
                                                            <?= Html::a('Hapus', ['borang-pasca-prodi/hapus-gambar'], ['class' => 'btn btn-danger btn-sm',
                                                                'data' => [
                                                                    'method' => 'POST',
