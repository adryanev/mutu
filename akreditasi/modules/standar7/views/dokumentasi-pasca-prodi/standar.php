...
$this->params['breadcrumbs'][] = ['label'=>'Isi Dokumentasi','url'=>['dokumentasi-pasca-prodi/isi','dokumentasi'=>$dokProdi->id]];
                                ...
                                <div class="col-md-12  ">
                                    <table class="table table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?=Html::a('<i class="material-icons">cloud_download</i> &nbsp;Download',['dokumentasi-pasca-prodi/download-dok','standar'=> $standar,'dok'=>$item['id'], 'dokumentasi'=>$_GET['dokumentasi']],['class'=>'btn btn-sm btn-info'])?>
                                                <br>
                                                <?php if($publik === 0) { echo Html::a('<i class="material-icons">lock</i> &nbsp;Tidak Publik',['dokumentasi-pasca-prodi/publik-standar','id'=>$item->id,'publik'=>1,'standar'=>$standar,'dokumentasi'=>$_GET['dokumentasi']],['class'=>'btn btn-sm btn-warning']); }
                                                else { echo Html::a('<i class="material-icons">public</i> &nbsp;Publik',['dokumentasi-pasca-prodi/publik-standar','id'=>$item->id,'publik'=>0,'standar'=>$standar,'dokumentasi'=>$_GET['dokumentasi']],['class'=>'btn btn-sm btn-success']);}
                                                ?>
                                                <br>
                                                <?php if($asesor === 0) { echo Html::a('<i class="material-icons">priority_high</i> &nbsp;Tidak Asesor',['dokumentasi-pasca-prodi/asesor-standar','id'=>$item->id,'asesor'=>1,'standar'=>$standar,'dokumentasi'=>$_GET['dokumentasi']],['class'=>'btn btn-sm btn-warning']); }
                                                else { echo Html::a('<i class="material-icons">school</i> &nbsp;Asesor',['dokumentasi-pasca-prodi/asesor-standar','id'=>$item->id,'asesor'=>0,'standar'=>$standar,'dokumentasi'=>$_GET['dokumentasi']],['class'=>'btn btn-sm btn-success']);}
                                                ?>
                                                <br>
                                                <?=Html::a('<i class="material-icons">delete</i> &nbsp;Hapus',['dokumentasi-pasca-prodi/hapus-standar'],['class'=>'btn btn-sm btn-danger',
                                                'data'=>[
                                                    'method'=>'POST',
                                ...
                                <div class="col-md-12 ">
                                    <table class="table table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <?=Html::a('<i class="material-icons">cloud_download</i> &nbsp;Download',['dokumentasi-pasca-prodi/download-dok','standar'=> $standar,'dok'=>$item->id, 'dokumentasi'=>$_GET['dokumentasi']],['class'=>'btn btn-sm btn-info'])?>
                                            <br>
                                            <?php if($publik === 0) { echo Html::a('<i class="material-icons">lock</i> &nbsp;Tidak Publik',['dokumentasi-pasca-prodi/publik-standar','id'=>$item['id'],'publik'=>1,'standar'=>$standar,'dokumentasi'=>$_GET['dokumentasi']],['class'=>'btn btn-sm btn-warning']); }else{ echo Html::a('<i class="material-icons">public</i> &nbsp;Publik',['dokumentasi-pasca-prodi/publik-standar','id'=>$item['id'],'publik'=>0,'standar'=>$standar,'dokumentasi'=>$_GET['dokumentasi']],['class'=>'btn btn-sm btn-success']);}
                                            ?>
                                            <br>
                                            <?php if($asesor === 0) { echo Html::a('<i class="material-icons">priority_high</i> &nbsp;Tidak Asesor',['dokumentasi-pasca-prodi/asesor-standar','id'=>$item->id,'asesor'=>1,'standar'=>$standar,'dokumentasi'=>$_GET['dokumentasi']],['class'=>'btn btn-sm btn-warning']); }
                                            else { echo Html::a('<i class="material-icons">school</i> &nbsp;Asesor',['dokumentasi-pasca-prodi/asesor-standar','id'=>$item->id,'asesor'=>0,'standar'=>$standar,'dokumentasi'=>$_GET['dokumentasi']],['class'=>'btn btn-sm btn-success']);}
