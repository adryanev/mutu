...
<div class="row">
    <div class="col-md-4">
        <div class="card card-product">
            <div class="card-image" data-header-animation="true">
                <a href="#pablo">
                    <?= Html::img('@web/img/card-2.jpeg',['class'=>'img'])?>
    ...
    <div class="col-md-4">
        <div class="card card-product">
            <div class="card-image" data-header-animation="true">
                <a href="#pablo">
                    <?= Html::img('@web/img/card-3.jpeg',['class'=>'img'])?>
    ...
    <div class="col-md-4">
        <div class="card card-product">
            <div class="card-image" data-header-animation="true">
                <a href="#pablo">
                    <?= Html::img('@web/img/card-1.jpeg',['class'=>'img'])?>
                </a>
            </div>
            <div class="card-content">
                <div class="card-actions">
