...
$this->title='Lihat';
$this->params['breadcrumbs'][] = ['label'=>'Borang','url'=>['borang/unggah']];
...
<div class="row">
    ...
    <div class="col-md-12">
                ...
                <div class="col-md-12 table-responsive ">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>ContohDokumen.zip</td>
                                <td><button class="btn btn-rose btn-sm"><i class="material-icons">save_alt</i> &nbsp;download</button></td>
                            </tr>
        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Lihat Borang</h4>
                ...
                <div class="col-md-12 table-responsive ">
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td><?=Html::a('Lihat',['borang/lihat-lihat'],['class'=>'btn btn-rose'])?></td>
                        </tr>
