                        ...
                        <table class="table table-hover">
                            ...
                            <?php foreach ($dataDokumenBorang as $item) :?>
                                <tr>
                                    ...
                                    <td> <?=Html::a('<i class ="material-icons">send</i> Download',['borang-institusi/download','dokumen'=>$item->id],['class'=>'btn btn-info']) ?>
                                       </td>
                                </tr>
                ...
                <div class="col-md-12 table-responsive ">
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td><?= Html::a('Lihat',['borang-institusi/lihat-standar','id'=>1,'borang'=>$borangInstitusi->id],['class'=>'btn btn-rose'])?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><?= Html::a('Lihat',['borang-institusi/lihat-standar','id'=>2,'borang'=>$borangInstitusi->id],['class'=>'btn btn-rose'])?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><?= Html::a('Lihat',['borang-institusi/lihat-standar','id'=>3,'borang'=>$borangInstitusi->id],['class'=>'btn btn-rose'])?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><?= Html::a('Lihat',['borang-institusi/lihat-standar','id'=>4,'borang'=>$borangInstitusi->id],['class'=>'btn btn-rose'])?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><?= Html::a('Lihat',['borang-institusi/lihat-standar','id'=>5,'borang'=>$borangInstitusi->id],['class'=>'btn btn-rose'])?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><?= Html::a('Lihat',['borang-institusi/lihat-standar','id'=>6,'borang'=>$borangInstitusi->id],['class'=>'btn btn-rose'])?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><?= Html::a('Lihat',['borang-institusi/lihat-standar','id'=>7,'borang'=>$borangInstitusi->id],['class'=>'btn btn-rose'])?></td>
                        </tr>
