...
class DetailBorangS1ProdiStandar6UploadForm extends Model
{
    ...
    public function uploadDokumen($id){
        ...
        if($this->validate()){
            $this->_detailBorangS1Prodi = new DetailBorangS1ProdiStandar6();
            $this->_detailBorangS1Prodi->id_borang_s1_prodi_standar6 = $id;
            ...
            $path = Yii::getAlias('@uploadAkreditasi'. "/BAN-PT/prodi/{$this->_detailBorangS1Prodi->borangS1ProdiStandar6->borangS1Prodi->akreditasiProdiS1->akreditasi->tahun}/{$this->_detailBorangS1Prodi->borangS1ProdiStandar6->borangS1Prodi->akreditasiProdiS1->id_prodi}/prodi/borang/dokumen");
