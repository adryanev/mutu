...
class S7DokumentasiS1ProdiStandar3Form extends S7DokumentasiS1ProdiStandar3
{
    ...
    public function uploadDokumen($id){
        ...
        if($this->validate()){
            $model = S7DokumentasiS1ProdiStandar3::find()->select('dokumen')->all();
            $this->_dokumenDokumentasi = new S7DokumentasiS1ProdiStandar3();
