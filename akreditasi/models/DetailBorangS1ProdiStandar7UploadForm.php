...
class DetailBorangS1ProdiStandar7UploadForm extends Model
{
    ...
    public function uploadDokumen($id){
        ...
        if($this->validate()){
            $this->_detailBorangS1Prodi = new DetailBorangS1ProdiStandar7();
            $this->_detailBorangS1Prodi->id_borang_s1_prodi_standar7 = $id;
            ...
            $path = Yii::getAlias('@uploadAkreditasi'. "/BAN-PT/prodi/{$this->_detailBorangS1Prodi->borangS1ProdiStandar7->borangS1Prodi->akreditasiProdiS1->akreditasi->tahun}/{$this->_detailBorangS1Prodi->borangS1ProdiStandar7->borangS1Prodi->akreditasiProdiS1->id_prodi}/prodi/borang/dokumen");
