...
class BorangS1FakultasForm extends Model
{
    ...
    public function uploadDokumen($id){
        ...
        if($this->validate()){
            ...
            $path = Yii::getAlias('@uploadAkreditasi'. "/BAN-PT/prodi/{$this->_dokumenBorangS1Fakultas->borangS1Fakultas->akreditasiProdiS1->akreditasi->tahun}/{$this->_dokumenBorangS1Fakultas->borangS1Fakultas->akreditasiProdiS1->id_prodi}/fakultas/borang/dokumen");
