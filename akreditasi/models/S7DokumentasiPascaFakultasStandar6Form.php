...
class S7DokumentasiPascaFakultasStandar6Form extends S7DokumentasiPascaFakultasStandar6
{
    ...
    public function uploadDokumen($id){
        ...
        if($this->validate()){
            $this->_dokumenDokumentasi = new S7DokumentasiPascaFakultasStandar6();
