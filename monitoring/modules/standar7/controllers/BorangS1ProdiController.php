...
//                    ],
    ...
    public function actionLihatStandar($id,$borang){
        $standarClass = 'common\\models\\S7BorangS1ProdiStandar'.$id;
        ...
        $data = $decode[$id-1];
        $poin = $data['poin'];
        $detailClass = "common\\models\\S7DetailBorangS1ProdiStandar".$id;
    ...
    public function actionIsiStandar($standar,$borang){
        ...
        $modelClass = 'akreditasi\\models\\S7BorangS1ProdiStandar'.$standar.'Form';
    ...
    public function actionDownloadDetail($standar,$dokumen,$borang){
        ...
        $class = $namespace.'S7DetailBorangS1ProdiStandar'.$standar;
    ...
    public function actionHapusDetail(){
        ...
        if(Yii::$app->request->isPost){
            ...
            return $this->redirect(['borang-s1-prodi/isi-standar','standar'=>$standar,'borang'=>$borang->id]);
        }
        throw new BadRequestHttpException('Request Harus Post');
    }
