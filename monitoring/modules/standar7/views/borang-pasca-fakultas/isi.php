                        ...
                        <table class="table table-hover">
                            ...
                            <?php foreach ($dataDokumenBorang as $item) :?>
                                <tr>
                                    ...
                                    <td> <?=Html::a('<i class ="material-icons">send</i> Download',['borang-pasca-fakultas/download','dokumen'=>$item->id],['class'=>'btn btn-info']) ?> <?=Html::a('<i class ="material-icons">delete</i> Hapus',['borang-pasca-fakultas/hapus-dokumen'],['class'=>'btn btn-danger','data'=>[
                                            'method'=>'POST',
                ...
                <div class="col-md-12 table-responsive ">
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td><?= Html::a('Lihat',['borang-pasca-fakultas/isi-standar','standar'=>1,'borang'=>$borangProdi->id],['class'=>'btn btn-rose'])?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><?= Html::a('Lihat',['borang-pasca-fakultas/isi-standar','standar'=>2,'borang'=>$borangProdi->id],['class'=>'btn btn-rose'])?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><?= Html::a('Lihat',['borang-pasca-fakultas/isi-standar','standar'=>3,'borang'=>$borangProdi->id],['class'=>'btn btn-rose'])?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><?= Html::a('Lihat',['borang-pasca-fakultas/isi-standar','standar'=>4,'borang'=>$borangProdi->id],['class'=>'btn btn-rose'])?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><?= Html::a('Lihat',['borang-pasca-fakultas/isi-standar','standar'=>5,'borang'=>$borangProdi->id],['class'=>'btn btn-rose'])?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><?= Html::a('Lihat',['borang-pasca-fakultas/isi-standar','standar'=>6,'borang'=>$borangProdi->id],['class'=>'btn btn-rose'])?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><?= Html::a('Lihat',['borang-pasca-fakultas/isi-standar','standar'=>7,'borang'=>$borangProdi->id],['class'=>'btn btn-rose'])?></td>
                        </tr>
