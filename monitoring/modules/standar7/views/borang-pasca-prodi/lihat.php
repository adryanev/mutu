                        ...
                        <table class="table table-hover">
                            ...
                            <?php foreach ($dataDokumenBorang as $item) :?>
                                <tr>
                                    ...
                                    <td> <?=Html::a('<i class ="material-icons">send</i> Download',['borang-pasca-prodi/download','dokumen'=>$item->id],['class'=>'btn btn-info']) ?>
                                       </td>
                                </tr>
                ...
                <div class="col-md-12 table-responsive ">
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td><?= Html::a('Lihat',['borang-pasca-prodi/lihat-standar','id'=>1,'borang'=>$borangProdi->id],['class'=>'btn btn-rose'])?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><?= Html::a('Lihat',['borang-pasca-prodi/lihat-standar','id'=>2,'borang'=>$borangProdi->id],['class'=>'btn btn-rose'])?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><?= Html::a('Lihat',['borang-pasca-prodi/lihat-standar','id'=>3,'borang'=>$borangProdi->id],['class'=>'btn btn-rose'])?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><?= Html::a('Lihat',['borang-pasca-prodi/lihat-standar','id'=>4,'borang'=>$borangProdi->id],['class'=>'btn btn-rose'])?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><?= Html::a('Lihat',['borang-pasca-prodi/lihat-standar','id'=>5,'borang'=>$borangProdi->id],['class'=>'btn btn-rose'])?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><?= Html::a('Lihat',['borang-pasca-prodi/lihat-standar','id'=>6,'borang'=>$borangProdi->id],['class'=>'btn btn-rose'])?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><?= Html::a('Lihat',['borang-pasca-prodi/lihat-standar','id'=>7,'borang'=>$borangProdi->id],['class'=>'btn btn-rose'])?></td>
                        </tr>
